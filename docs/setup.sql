...
ALTER TYPE "public"."charge_type" RENAME TO "charge_type_before_credits";
...
ALTER TABLE "invoices" ALTER COLUMN "type" TYPE "public"."charge_type"
	USING "type"::text::"public"."charge_type";

DROP TYPE "public"."charge_type_before_credits";
...
-- ---------------------------------------------------------------
-- migration: 0012_numbering_per_workspace
-- ---------------------------------------------------------------
...
ALTER TABLE "properties" DROP CONSTRAINT IF EXISTS "properties_code_unique";
ALTER TABLE "bookings" DROP CONSTRAINT IF EXISTS "bookings_reference_unique";
ALTER TABLE "invoices" DROP CONSTRAINT IF EXISTS "invoices_number_unique";
ALTER TABLE "maintenance_requests" DROP CONSTRAINT IF EXISTS "maintenance_requests_reference_unique";

CREATE UNIQUE INDEX IF NOT EXISTS "properties_code_per_org"
	ON "properties" USING btree ("organization_id", "code");
CREATE UNIQUE INDEX IF NOT EXISTS "bookings_reference_per_org"
	ON "bookings" USING btree ("organization_id", "reference");
CREATE UNIQUE INDEX IF NOT EXISTS "invoices_number_per_org"
	ON "invoices" USING btree ("organization_id", "number");
...
INSERT INTO "drizzle"."__drizzle_migrations" (hash, created_at) VALUES ('e4821b8f24bf4ed2a4f1326ba9565d8535fb773e52110b2f18de2329f50a9bcc', 1787900800000);
INSERT INTO "drizzle"."__drizzle_migrations" (hash, created_at) VALUES ('d22e72910b3fb0f892849b3b72452a0d198e6b3c61bbb997004f9eff17508dd4', 1787900900000);
